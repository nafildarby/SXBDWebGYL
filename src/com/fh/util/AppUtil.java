...
public class AppUtil  {
	...
	/**
	 * 获取String类型的整数随机数
	 * @param size 获取的随机数的位数
	 * @return
	 */
	public static String getRandomNum(int size){
		long startNumber = (long)Math.pow(10, size -1);
		long endNumber = (long)(Math.pow(10, size) - 1 );
		long a = (long)(Math.random()*(endNumber-startNumber+1))+startNumber;
