...
public class MenuService{
	...
	public Menu getMenuByUrl(String menuUrl) throws Exception {
		return (Menu)dao.findForObject("MenuMapper.getMenuByUrl", menuUrl);
	}
	 ...
	 * 查询所有菜单
	 */
	public List<PageData> AllMenulist()throws Exception{
		return (List<PageData>) dao.findForList("MenuMapper.AllMenulist",null);
	}
}
