...
public class Page {
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			sb.append("	<option value='"+rows+"'>"+rows+"</option>\n");
			...
			sb.append("		if(url.indexOf('?')>-1){url += \"&"+(entityOrField?"page":"page.page")+"=\";}\n");
			sb.append("		else{url += \"?"+(entityOrField?"page":"page.page")+"=\";}\n");
			sb.append("		url = url + page + \"&" +(entityOrField?"rows":"page.rows")+"="+rows+"\";\n");
			...
			sb.append("			}else{\n");
			sb.append("				url += \"&"+(entityOrField?"page":"page.page")+"=\";\n");
			sb.append("			}\n");
			sb.append("		}else{url += \"?"+(entityOrField?"page":"page.page")+"=\";}\n");
			sb.append("		url = url + page + \"&" +(entityOrField?"rows":"page.rows")+"="+rows+"\";\n");
			...
			sb.append("		if(url.indexOf('?')>-1){url += \"&"+(entityOrField?"page":"page.page")+"=\";}\n");
			sb.append("		else{url += \"?"+(entityOrField?"page":"page.page")+"=\";}\n");
			sb.append("		url = url + \"1&" +(entityOrField?"rows":"page.rows")+"=\"+value;\n");
			sb.append("		document.forms[0].action = url;\n");
			sb.append("		document.forms[0].submit();\n");
			sb.append("	}else{\n");
			sb.append("		var url = document.location+'';\n");
			...
			sb.append("				url = url.replace(reg,'page=');\n");
			sb.append("			}else{\n");
			sb.append("				url += \"1&"+(entityOrField?"page":"page.page")+"=\";\n");
			sb.append("			}\n");
			sb.append("		}else{url += \"?"+(entityOrField?"page":"page.page")+"=\";}\n");
			sb.append("		url = url + \"&" +(entityOrField?"rows":"page.rows")+"=\"+value;\n");
			sb.append("		document.location = url;\n");
			sb.append("	}\n");
			sb.append("}\n");
