...
//		return mv;
	...
	public ModelAndView toEdit( String ROLE_ID )throws Exception{
		...
		pd = roleService.findObjectById(pd); // 根据ID读取
...
//		return mv;
	...
	@ResponseBody
	public Map<String, Object> RoleMenu(@RequestParam String ROLE_ID,Model model)throws Exception{
		try{
			List<Menu> menuList = menuService.listAllMenu();
			Role role = roleService.getRoleById(ROLE_ID);
			String roleRights = role.getRIGHTS();
	...
	@ResponseBody
	public Map<String, Object> button(@RequestParam String ROLE_ID,@RequestParam String msg,Model model)throws Exception{
		ModelAndView mv = this.getModelAndView();
		try{
			List<Menu> menuList = menuService.listAllMenu();
			Role role = roleService.getRoleById(ROLE_ID);
