...
<div style="height:100%;">
    <div class="easyui-accordion" style="height:auto;">
            ...
            <table class="tab" border="0" cellpadding="3px" cellspacing="0" width="100%">
            	<tbody>
                    <tr>
                       ...
                       <td>
							<input id="inboundNo" value="${pd.IncomeCode}" class="easyui-textbox" style="width:220px;">					 
						</td>
                       <td class="tabAlign" >入库仓库：</td>
                       <td>
							<input id="combotree" value="${pd.WarehouseName}" class="easyui-textbox" style="width:220px;">					 
						</td> 
                    ...
                    <tr>
                       ...
                       <td>
							<input id="inboundDate" value="${pd.IncomeDate}" class="easyui-textbox" style="width:220px;">					 
						</td> 
 					    <td class="tabAlign">供应商：</td>   
						<td> 
							<input id="SupplierId" value="${pd.EnterpriseName}" class="easyui-textbox" style="width:220px;">		 
                        </td>   
                    </tr>
                    <tr>
                        <td class="tabAlign">备注：</td>
                        <td colspan="10">
                        	<textarea class="easyui-validatebox validatebox-text" id="Note" cols="88" style="width:93%;height:20px;">${pd.Note}</textarea>
                        </td> 
                    </tr>
                </tbody>
            </table>
        ...
        <fieldset class="scheduler-border">
        	...
        	<div style="width: auto; background-color: rgb(222, 235, 250); margin: 2px;" class="panel datagrid">
				<div  title="" class="datagrid-wrap panel-body panel-body-noheader"> 
					<table id="productSelect" data-options="iconCls:'icon-edit',singleSelect:true">
						<thead>
					    	<tr> 
					        	<th data-options="field:'ProductName',align:'center',width:fixWidth(0.155)">物料名称</th>
					            <th data-options="field:'ProductNo',align:'center',width:fixWidth(0.18)">物料编码</th>
					          	<th data-options="field:'Comment',align:'center',width:fixWidth(0.17)">物料描述</th>
					           	<th data-options="field:'TotalNum',align:'center',width:fixWidth(0.08)" >数量</th>
					          	<th data-options="field:'Unit',align:'center',width:fixWidth(0.08)">单位</th>
					           	<th data-options="field:'Price',align:'center',width:fixWidth(0.08)">单价</th>
					           	<th data-options="field:'SupplierName',align:'center',width:fixWidth(0.16)">供应商名称</th> 
					     	</tr>
					 	</thead>
						<tbody>
					   		<c:forEach items="${gdlist}" var="gd">
					      		<tr>
					        		...
					        		<td class="center" style="cursor:pointer">${gd.ProductNo}</td>
...
<script type="text/javascript"> 
	...
	function appliBtn(){ 
		$.ajax({
			type:"post",
			url:"inbound/saveApplyData",
			dataType:"json",
			data:{ 
				"ApplyNo": '${pd.IncomeCode}',
				"Common":$("#common").val()
			}, 
	...
	function repulseBtn() {  
		$.ajax({
			type:"post",
			url:"inbound/saveApplyDataRepulse",
			dataType:"json",
			data:{ 
				"ApplyNo": '${pd.IncomeCode}',
				"Common":$("#common").val()
