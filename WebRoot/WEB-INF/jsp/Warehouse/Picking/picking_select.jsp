					...
					<div  title="" class="datagrid-wrap panel-body panel-body-noheader"> 
						...
						<tr>
		                	<td class="tabAlign">审核意见：</td>
		                   	<td colspan="15">
		                		<textarea class="easyui-validatebox validatebox-text" id="Note" cols="148" style="margin:10px auto;width:99%;height:80px;"></textarea>
		                    </td>
		                </tr>
		             	</table>
		             </div>
       ...
       <div title="明细信息" style="padding:10px;">
            ...
            <table class="tab" border="0" cellpadding="3px" cellspacing="0" width="100%">
             	<tbody>  
                   <tr>  
                        ...
                        <td>
                        	<input id="outCode" class="easyui-textbox" value="${pd.PickingNo}"  style="width:180px;" />
                        </td>
                        <td class="tabAlign">入库仓库：</td>
                        <td>
                        	<input id="outWHNo"  class="easyui-textbox" value="${pd.WarehouseName}"  style="width:180px;" />
                        </td> 
                    </tr>
                    <tr>  
                        <td class="tabAlign">出库时间：</td> 
                        <td>
                        	<input id="OutTime" class="easyui-textbox" value="${pd.PickingTime}"  style="width:180px;" />
                        </td>
                        <td class="tabAlign">操作人：</td>
                        <td>
                        	<input id="OpName" class="easyui-textbox" value="${pd.PickingPerson}"   style="width:180px;" />
                        </td> 
                    </tr> 
                    <tr>
        ...
        <div style="margin:0px 10px 0px 10px;clear:both;">
         	<fieldset class="scheduler-border">
                ...
                <div style="width: auto; background-color: rgb(222, 235, 250); margin: 2px;" class="panel datagrid">
					<div  title="" class="datagrid-wrap panel-body panel-body-noheader"> 
						<table id="pick" data-options="iconCls:'icon-edit'">
					        <thead>
					            <tr>  
					                ...
					                <th data-options="field:'Comment',align:'center',width:fixWidth(0.175)">物料描述</th>
					                <th data-options="field:'ApplyNum',align:'center',width:fixWidth(0.12)">申请数量</th>
					                <th data-options="field:'DeployNum',align:'center',width:fixWidth(0.12)" >调配数量</th>
					                <th data-options="field:'Unit',align:'center',width:fixWidth(0.11)">单位</th> 
					            </tr>
					        </thead>
					        <tbody>
					   		<c:forEach items="${gdlist}" var="gd">
					      		<tr>
					        		...
					        		<td class="center" style="cursor:pointer">${gd.ApplyNum}</td>
...
<script type="text/javascript"> 
	...
	function appliBtn(){ 
		$.ajax({
			type:"post",
			url:"pick/saveApplyData",
			dataType:"json",
			data:{ 
				"ApplyNo":'${pd.PickingNo}',  
				"Common":$("#Note").val()   
			}, 
